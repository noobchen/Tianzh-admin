package com.tianzh.admin.common.util.string;
...
public class StringUtils {
    //字符串左边补0直到长度为i
    public static String obox(String s, int length) {
        String ss = s;
    ...
    //字符串右边补0直到长度为i
    public static String boxo(String s, int length) {
        String ss = s;
        while (ss.length() < length) {
            ss += "0";
        }
    ...
    //char数组转换为String数组
    public static String[] ss2Ss(char[] s) {
    ...
    //char数组转换为hexString
    public static String ss2hexStr(char[] s) {
        StringBuffer sb = new StringBuffer();
        //string[] result = new string[s.length];
        for (int i = 0; i < s.length; i++) {
