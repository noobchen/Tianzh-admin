package com.tianzh.admin.common.permission.controller;
...
import com.tianzh.admin.common.permission.service.RoleService;
import com.tianzh.admin.common.util.account.AccountUtils;
import com.tianzh.admin.common.util.account.PasswordUtils;
...
public class OperatorController {
    ...
    public ModelAndView add(@RequestParam("operatorName") String operatorName,
        ...
        operator.setAccount(account);//AccountUtils.getCustomerAccount()
        operator.setPassword(password);//PasswordUtils.decode(operator.getAccount())
