package com.tianzh.admin.common.spring.mvc.interceptor;

import com.tianzh.admin.business.login.controller.LoginController;
import com.tianzh.admin.common.permission.model.Operate;
import com.tianzh.admin.common.permission.model.Resource;
import com.tianzh.admin.common.permission.util.UrlEncryption;
...
public class RequestInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        if (StringUtils.contains(url, ".do")
                ...
                && !StringUtils.contains(url, "load.do")
                && !StringUtils.contains(url, "notify.do")) {
